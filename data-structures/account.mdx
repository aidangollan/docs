...
| `warmup_version` | `'original' \| 'v1_smart' \| null` | Warmup scheduling algorithm version. `'original'` uses the standard scheduling logic, `'v1_smart'` uses an optimized algorithm (coming soon) |

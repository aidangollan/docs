...
`PostType`, `PostStatus`, `Post`, `PostStat`, `GetPostsParams`, `CreateSlideshowParams`, `GetPostStatsParams`, `GetPostStatusParams`, `CreateVideoParams`, `UpdatePostParams`, `DeletePostsParams`, `DeletePostsResponse`, `RetryPostsParams`, `SetPostStatusParams`, `SetPostStatusResponse`, `PreviewScheduleEntry`, `PreviewScheduleParams`, `PreviewScheduleResult`

...
description: "Update account metadata (tag, groups, keywords, profiles)"
---
...
Update account metadata including tag, organization group, user group, keywords, and profiles. This endpoint updates the internal categorization and grouping of accounts without modifying the social media profile itself.
...
<Note>
  At least one of `tag`, `org_group`, `user_group`, `keywords`, or `profiles` must be provided.
</Note>
